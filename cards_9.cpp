...
int main(){
    ...
    for(int i = 0; i < product.size(); i++) {
        ...
        write_csv(best_choices, best_results, "best_choices_9.csv");
        ...
        for(int i2 = i1+1; i2 < X_s.size(); i2++){
            for(int i3 = i2+1; i3 < X_s.size(); i3++){
                for(int i4 = i3+1; i4 < X_s.size(); i4++){
                    for(int i5 = i4+1; i5 < X_s.size(); i5++){
                        vector<int> line{X_s[i1], X_s[i2], X_s[i3], X_s[i4], X_s[i5]};
                        Ex.push_back(line);
                    }
                }
            }
